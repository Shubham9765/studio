...
import { AlertTriangle, CheckCircle, ShoppingCart, Banknote, Landmark, Crosshair, Loader2, Home, Building, Map, Carrot } from 'lucide-react';
...
export default function GroceryCheckoutPage() {
    const { cart, store, totalPrice, clearCart } = useGroceryCart();
    ...
    const deliveryFee = store?.deliveryCharge || 0;
            ...
            <div className="min-h-screen bg-background">
                ...
                <main className="container py-8 flex items-center justify-center text-center">
                    <Card className="w-full max-w-md">
                        <CardHeader>
                            <Carrot className="mx-auto h-12 w-12 text-muted-foreground" />
                        </CardHeader>
                        <CardContent>
                            <h2 className="text-2xl font-bold">Your grocery cart is empty</h2>
                            <p className="text-muted-foreground mt-2">Looks like you haven't added any items yet.</p>
                        </CardContent>
                        <CardFooter>
                            <Button className="w-full" onClick={() => router.push('/grocery')}>Start Shopping</Button>
                        </CardFooter>
                    </Card>
                </main>
            </div>
                ...
                <main className="container py-8 flex items-center justify-center text-center">
                    <Card className="w-full max-w-md">
                        ...
                        <CardFooter className="flex-col gap-2">
                            ...
                            <Button className="w-full" variant="outline" onClick={() => router.push('/grocery')}>Continue Shopping</Button>
                        </CardFooter>
                    </Card>
                </main>
            </div>
    ...
    return (
        <div className="min-h-screen bg-background">
            <Header />
            <main className="container py-8">
                <h1 className="text-3xl font-bold mb-8">Grocery Checkout</h1>
                            ...
                            <Card>
                                ...
                                <CardContent className="space-y-6">
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        <Textarea 
                                            id="orderNotes"
                                            placeholder="e.g., call upon arrival, etc."
                                            value={orderNotes}
                                    ...
                                    <Separator />
                                     ...
                                     <div className="space-y-4">
                                        <Label>Payment Method</Label>
                                         <RadioGroup value={paymentMethod} onValueChange={(val) => setPaymentMethod(val as 'cash')} className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <aside>
                        <Card>
                            <CardHeader>
                                ...
                                <CardDescription>From: {store?.name}</CardDescription>
                            </CardHeader>
